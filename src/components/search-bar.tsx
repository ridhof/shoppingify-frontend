  ...
  return (
    <div className="relative mt-2 rounded-md shadow-[0_2px_12px_2px_rgba(0,0,0,0.05)]">
      ...
      <input
        ...
        name="search"
        id="search"
        className="block h-12 w-full rounded-xl border-0 bg-white pl-14 text-gray-900 placeholder:text-sm placeholder:font-medium placeholder:text-gray-300 focus:ring-2 focus:ring-inset focus:ring-primary"
